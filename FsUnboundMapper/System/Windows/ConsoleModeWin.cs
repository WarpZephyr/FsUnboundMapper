...
namespace FsUnboundMapper.System.Windows
{
    ...
    public static class ConsoleModeWin
    {
        ...
        public static bool GetConsoleMode(out ConsoleModeWinFlags mode)
        {
            try
            {
                nint conHandle = GetStdHandle(STD_INPUT_HANDLE);
                if (!ConsoleModeWin32Native.GetConsoleMode(conHandle, out uint rawMode))
                {
        ...
        public static bool SetConsoleMode(ConsoleModeWinFlags mode)
        {
            ...
            {
                nint conHandle = GetStdHandle(STD_INPUT_HANDLE);
                if (!ConsoleModeWin32Native.SetConsoleMode(conHandle, (uint)mode))
                {
